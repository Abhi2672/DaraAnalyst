...
with models.DAG(
    ...
    load_csv = GCSToBigQueryOperator(
        ...
        bucket='abhishek1-bucket1',
        source_objects=['data/sample_data.csv'],
        destination_project_dataset_table='data-proc-457704.sample.people',
        schema_fields=[
    ...
    query_job = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": "SELECT name, age FROM `data-proc-457704.sample.people` WHERE age > 28",
                "useLegacySql": False,
            }
        },
    )
